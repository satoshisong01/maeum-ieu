...
판정 원칙: 확실치 않으면 보수적으로 — 진짜 위기를 놓치는 것보다 약하게라도 잡는 게 낫습니다. 단, 단순 복약 질문·부정문·평범한 일상, 그리고 "보고 싶어 죽겠다 / 좋아 죽겠다 / 배고파 죽겠다 / 보고 싶어 죽겠어"처럼 그리움·강조의 관용 표현(실제 자살 의도 아님)은 반드시 none(과잉경보 금지). 자살은 스스로 목숨을 끊으려는 실제 의도가 있을 때만.
