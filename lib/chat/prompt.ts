...
→ "이미 확인한 영역"의 질문은 어떤 형태로든 절대 반복하지 마세요.
  · 예: language 확인 끝났으면 "백문이 불여일견 뜻", "간장 공장 따라말하기", "ㅁ으로 시작하는 단어" 어떤 변형도 금지.
  · 예: attention_calculation 확인 끝났으면 "100-7", "거스름돈", "삼천리강산 거꾸로" 어떤 변형도 금지.
  · 같은 영역의 다른 문제로 바꿔 묻는 것도 금지입니다. 진짜 새 영역만 묻거나, 질문 없이 일상 대화로 이어가세요.
