/**
 * AWS RDS CA 인증서 번들 (ap-northeast-2) — DB TLS 서버 인증서 검증용.
 * 출처: https://truststore.pki.rds.amazonaws.com/ap-northeast-2/ap-northeast-2-bundle.pem
 * RDS는 자체 CA로 서명하므로 시스템 신뢰저장소엔 없음 → 이 번들로 검증(no-verify 대체).
 */
